  ...
  return (
    <footer className="bg-[#f3f4f6] text-gray-700 py-16 px-6 border-t border-gray-200">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        {/* Navigation */}
        <div>
          <h4 className="font-semibold mb-3 text-gray-800">{t("footExplore")}</h4>
        ...
        {/* Resources */}
        <div>
          <h4 className="font-semibold mb-3 text-gray-800">{t("footResources")}</h4>
          <ul className="space-y-2 text-sm">
            <li>
        ...
        {/* Contact / Social */}
        <div>
          <h4 className="font-semibold mb-3 text-gray-800">{t("footConnect")}</h4>
          <p className="text-sm mb-4 text-gray-600">
            {/* <span className="block">{t("footEmail")}</span> */}
            <span className="block">{t("footMobile")}</span>
            <span className="block mt-2">{t("footLocation")}</span>
          </p>
          <div className="flex space-x-4">
            <Link
              href="https://www.instagram.com/doctorshubhamsinghal/"
      ...
      <div className="mt-12 text-center text-xs text-gray-500">
        © {new Date().getFullYear()} {t("footRights")}
      </div>
    </footer>
  );
}
